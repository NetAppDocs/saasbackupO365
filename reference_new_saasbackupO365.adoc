...
== June 2020
* SaaS Backup for Microsoft Office 365 now supports advanced search capabilities for Exchange Online users for up to six months. Once enabled, a user can search for individual or shared mailbox items and restore those items to the original mailbox.
+
