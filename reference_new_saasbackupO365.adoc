...
== March 2020
* We have enhanced the Teams backup feature by adding protection for chat, channels, tabs, and group memberships. This feature is available to EU only. Stay tuned for wider access to the Teams Chat feature. 
