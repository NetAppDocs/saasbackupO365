...
** Backup and restore of archived mailboxes.
** Download of restore statistics for Microsoft Exchange Online, OneDrive for Business, and SharePoint Online.
** Creation and utilization of up to three security groups.
   <<task_managing_services.adoc#adding_security_groups,Adding security groups>>
