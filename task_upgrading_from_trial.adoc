...
If you change your backup storage destination type or your backup storage region when you upgrade, your trial data is loss.
...
Any change to your backup destination region results in data loss.
