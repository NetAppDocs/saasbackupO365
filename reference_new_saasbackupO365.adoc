...
== June 2020
* SaaS Backup for Microsoft 365 now supports advanced search capabilities for Exchange Online users. Once enabled, a user can search for individual, shared, and archive mailbox items within the last six months of backup data.
...
+
link:updating_subscription_information.html[Updating subscription information]
