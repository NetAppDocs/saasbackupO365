...
... Click *Confirm*.
//... You can see job progress under *Jobs* on the left menu. 
//.... After *Restore to the same mailbox*
//.... After the *Export Data* job completes, go to *Reporting* in the left menu. Seelect *Total Folders*
