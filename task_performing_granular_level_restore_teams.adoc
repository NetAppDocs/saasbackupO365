...
= Performing a granular-level restore for Microsoft 365 Groups/Teams
:toc: macro
:toclevels: 1
:hardbreaks:
:nofooter:
...
[.lead]
Within Microsoft 365 Groups/Teams, you can restore granular-level items like mailboxes, SharePoint, conversations, channels, tabs, and attachments.
