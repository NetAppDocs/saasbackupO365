...
.. If you are restoring teams under *Microsoft Office 365 Groups* select one of the following options:
   ...
   * Restore to another team
     To restore to another team, the other team must already exist in SaaS Backup. If you have recently created the team in MS Teams, discover the new team by syncing the service. Go to *Services Settings* on the left. Click *Office 365*. Under *Manage Services*, click *Sync Now* for Microsoft Office 365 Groups.
   * Export data
