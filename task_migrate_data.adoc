...
+
You can see the migration status for the account.
...
*Additional steps for NetApp provided Amazon Web Services S3 buckets*
If you have Amazon Web Services S3 buckets, Policy and Policy Note appear below Consent. Follow the next steps to finalize your data migration request.
