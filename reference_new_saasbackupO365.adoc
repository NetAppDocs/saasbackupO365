...
*	The SaaS Backup Export Utility tool is now available and facilitates the export of your migrated data to Amazon Web Services S3 and Azure Blob destination buckets, or local storage. Sign in to link:mysupportnetapp.com[NetApp Support]. Then visit link:https://mysupport.netapp.com/site/tools[the NetApp Support Tools page] and search for the SaaS Backup Export Tool.
