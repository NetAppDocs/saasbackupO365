...
== March 2020
* SaaS Backup now supports backup to Teams. This feature is only available to customers in Europe and must be requested through Support. The TeamsChat backup feature has protection for chat, channels, tabs, and group memberships.
