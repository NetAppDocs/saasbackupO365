...
[.lead]
After you have completed the setup process for NetApp SaaS Backup, you can use SaaS Backup for Office 365 to manage backups of Microsoft Exchange Online, Microsoft OneDrive for Business, and Microsoft SharePoint Online.
...
|=======
|Backup policy |Backup frequency |Default data retention period for production |Default data retention period for sandbox
|Tier 1 |Once every 12 hours |3 years |2 years
|Tier 2 |Once every 18 hours |3 years |2 years
|Tier 3 |Once every 24 hours |3 years |2 years
|=======
...
== Supported apps for Microsoft SharePoint Online
