...
+
NOTE: By default, advanced search is disabled for all users. This feature can only be enabled at the individual user level in *Advanced Search Settings* under the *Advanced Search* column.  
...
* Subject: Check this box search by subject only.
