...
== March 2020
* SaaS Backup now supports backup to Microsoft TeamsChat. This feature is only available to customers in Europe and must be requested through Support. Now you can backup and restore your conversations, channels, tabs, and attachments found in Microsoft TeamsChat. 
