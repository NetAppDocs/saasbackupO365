...
. Go to this http://o365setup.com/#Trial+Center[site]  to start your trial subscription.
...
. Click http://www.netapp.com/us/products/cloud-storage/cloud-control-backup-saas.aspx[here] to go to the SaaS Backup for Office 365 free-trial URL.
