...
For granular-level restores for SharePoint online, go to  link:task_performing_granular_level_restore_sharepoint.html[Perform a granular-level restore for Microsoft SharePoint Online].
